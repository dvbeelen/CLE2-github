...
<div class="form">
    <form>
        <h2> Wat is uw telefoonnummer? </h2>
        <input class="inputBar" type="number" name="phonenumb">
    </form>
</div>

<div class="pageNav">
    <button class="lastPage"><a href="formLastName.php">Vorige pagina</a></button>
    <button class="nextPage"><a href="formMail.php">Volgende pagina</a></button>
</div>
