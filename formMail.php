...
<div class="form">
    <form>
        <h2> Wat is uw e-mail? </h2>
        <input class="inputBar" type="text" name="phonenumber">
    </form>
</div>

<div class="pageNav">
    <button class="lastPage"><a href="formPhone.php">Vorige pagina</a></button>
    <button class="nextPage"><a href="formDate.php">Volgende pagina</a></button>
</div>
