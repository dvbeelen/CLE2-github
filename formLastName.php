...
<div class="form">
    <form>
        ...
        <input class="inputBar" type="text" name="lastname">
    </form>
</div>

<div class="pageNav">
    <button class="lastPage"><a href="formName.php">Vorige pagina</a></button>
    <button class="nextPage"><a href="formPhone.php">Volgende pagina</a></button>
</div>
